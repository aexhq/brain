...
def main() -> None:
    ...
    digests = {
        "contracts/agentloop/v1/contract.digest": values["AGENTLOOP_SCHEMA"],
        "contracts/agentloop/v1/agentloop.digest": values["AGENTLOOP_WIT"],
        "contracts/environment/v1/contract.digest": values["ENVIRONMENT_SCHEMA"],
        "contracts/tool/v1/contract.digest": values["TOOL_SCHEMA"],
        "contracts/session/v1/contract.digest": values["SESSION_SCHEMA"],
    }
