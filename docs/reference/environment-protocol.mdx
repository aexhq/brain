...
Resource lifetime belongs to the Environment's configuration. Automatic session creation calls setup,
...
[Control environments](/brain/docs/guides/environment-control) for grants and templates.
