...
The answer is saved and returned before this call finishes. Brain journals the call and its
outcome and waits for it before starting another turn or completing a graceful drain. A failed
