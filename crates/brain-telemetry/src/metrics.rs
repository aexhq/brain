...
impl TelemetryMetrics {
    pub fn queued_records(&self) -> usize { self.inner.queued_records.load(Ordering::Relaxed) }
    pub fn queued_bytes(&self) -> usize { self.inner.queued_bytes.load(Ordering::Relaxed) }
    pub fn dropped_records(&self) -> u64 { self.inner.dropped_records.load(Ordering::Relaxed) }
    ...
    pub(crate) fn dropped(&self) { self.inner.dropped_records.fetch_add(1, Ordering::Relaxed); }
}
