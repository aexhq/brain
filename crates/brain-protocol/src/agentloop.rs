...
impl ActivationRequestMessage {
    pub fn builder() -> builder::ActivationRequestMessage {
        Default::default()
    }
}
...
impl ActivationResult {
    pub fn builder() -> builder::ActivationResult {
        Default::default()
    }
}
...
impl AgentloopError {
    pub fn builder() -> builder::AgentloopError {
        Default::default()
    }
}
...
impl AssistantMessageView {
    pub fn builder() -> builder::AssistantMessageView {
        Default::default()
    }
}
...
impl BrainAgentloopContract {
    pub fn builder() -> builder::BrainAgentloopContract {
        Default::default()
    }
}
...
impl BrainAgentloopContractContract {
    pub fn builder() -> builder::BrainAgentloopContractContract {
        Default::default()
    }
}
...
impl CtxOpRequest {
    pub fn builder() -> builder::CtxOpRequest {
        Default::default()
    }
}
...
impl MarkView {
    pub fn builder() -> builder::MarkView {
        Default::default()
    }
}
...
impl ModelRequest {
    pub fn builder() -> builder::ModelRequest {
        Default::default()
    }
}
...
impl SessionContextView {
    pub fn builder() -> builder::SessionContextView {
        Default::default()
    }
}
...
impl SessionContextViewLimits {
    pub fn builder() -> builder::SessionContextViewLimits {
        Default::default()
    }
}
#[doc = "`SessionId`"]
...
impl TextContentView {
    pub fn builder() -> builder::TextContentView {
        Default::default()
    }
}
...
impl ToolCallContentView {
    pub fn builder() -> builder::ToolCallContentView {
        Default::default()
    }
}
...
impl ToolCallRequest {
    pub fn builder() -> builder::ToolCallRequest {
        Default::default()
    }
}
...
impl ToolPresentationView {
    pub fn builder() -> builder::ToolPresentationView {
        Default::default()
    }
}
...
impl ToolResultView {
    pub fn builder() -> builder::ToolResultView {
        Default::default()
    }
}
...
impl UsageView {
    pub fn builder() -> builder::UsageView {
        Default::default()
    }
}
...
pub mod builder {
    ...
    pub struct ActivationRequestMessage {
        ...
        content: ::std::result::Result<::std::vec::Vec<super::ContentView>, ::std::string::String>,
        seq: ::std::result::Result<super::Seq, ::std::string::String>,
    }
    impl ::std::default::Default for ActivationRequestMessage {
        fn default() -> Self {
            Self {
    ...
    impl ActivationRequestMessage {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::ContentView>>,
            T::Error: ::std::fmt::Display,
        {
            self.content = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<super::Seq>,
            T::Error: ::std::fmt::Display,
        {
            self.seq = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<ActivationRequestMessage> for super::ActivationRequestMessage {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ActivationRequestMessage,
    ...
    impl ::std::convert::From<super::ActivationRequestMessage> for ActivationRequestMessage {
        fn from(value: super::ActivationRequestMessage) -> Self {
            Self {
                at: Ok(value.at),
    ...
    #[derive(Clone, Debug)]
    pub struct ActivationResult {
        activation_id: ::std::result::Result<super::Identifier, ::std::string::String>,
        error: ::std::result::Result<
            ::std::option::Option<super::AgentloopError>,
            ::std::string::String,
        >,
        outcome: ::std::result::Result<super::ActivationResultOutcome, ::std::string::String>,
    }
    impl ::std::default::Default for ActivationResult {
        fn default() -> Self {
            Self {
                activation_id: Err("no value supplied for activation_id".to_string()),
    ...
    impl ActivationResult {
        pub fn activation_id<T>(mut self, value: T) -> Self
        where
            ...
            T::Error: ::std::fmt::Display,
        {
            self.activation_id = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for activation_id: {e}"));
            self
        }
        pub fn error<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::AgentloopError>>,
            T::Error: ::std::fmt::Display,
        {
            self.error = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<super::ActivationResultOutcome>,
            T::Error: ::std::fmt::Display,
        {
            self.outcome = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<ActivationResult> for super::ActivationResult {
        type Error = super::error::ConversionError;
        fn try_from(
    ...
    impl ::std::convert::From<super::ActivationResult> for ActivationResult {
        fn from(value: super::ActivationResult) -> Self {
            Self {
                activation_id: Ok(value.activation_id),
    ...
    #[derive(Clone, Debug)]
    pub struct AgentloopError {
        code: ::std::result::Result<super::AgentloopErrorCode, ::std::string::String>,
        details: ::std::result::Result<
            ::serde_json::Map<::std::string::String, ::serde_json::Value>,
            ::std::string::String,
        >,
        message: ::std::result::Result<super::AgentloopErrorMessage, ::std::string::String>,
        retryable: ::std::result::Result<bool, ::std::string::String>,
    }
    impl ::std::default::Default for AgentloopError {
        fn default() -> Self {
            Self {
    ...
    impl AgentloopError {
        ...
        where
            T: ::std::convert::TryInto<super::AgentloopErrorCode>,
            T::Error: ::std::fmt::Display,
        {
            self.code = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<super::AgentloopErrorMessage>,
            T::Error: ::std::fmt::Display,
        {
            self.message = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<AgentloopError> for super::AgentloopError {
        type Error = super::error::ConversionError;
        fn try_from(
            value: AgentloopError,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                code: value.code?,
    ...
    impl ::std::convert::From<super::AgentloopError> for AgentloopError {
        fn from(value: super::AgentloopError) -> Self {
            Self {
                code: Ok(value.code),
    ...
    pub struct AssistantMessageView {
        content: ::std::result::Result<::std::vec::Vec<super::ContentView>, ::std::string::String>,
        model: ::std::result::Result<super::Identifier, ::std::string::String>,
        stop_reason: ::std::result::Result<super::ModelStopReason, ::std::string::String>,
        usage:
            ::std::result::Result<::std::option::Option<super::UsageView>, ::std::string::String>,
    }
    impl ::std::default::Default for AssistantMessageView {
        fn default() -> Self {
            Self {
                content: Err("no value supplied for content".to_string()),
    ...
    impl AssistantMessageView {
        ...
        where
            T: ::std::convert::TryInto<super::ModelStopReason>,
            T::Error: ::std::fmt::Display,
        {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::UsageView>>,
            T::Error: ::std::fmt::Display,
        {
            self.usage = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<AssistantMessageView> for super::AssistantMessageView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: AssistantMessageView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                content: value.content?,
                model: value.model?,
    ...
    impl ::std::convert::From<super::AssistantMessageView> for AssistantMessageView {
        fn from(value: super::AssistantMessageView) -> Self {
            Self {
                content: Ok(value.content),
    ...
    pub struct BrainAgentloopContract {
        contract:
            ::std::result::Result<super::BrainAgentloopContractContract, ::std::string::String>,
    }
    impl ::std::default::Default for BrainAgentloopContract {
        fn default() -> Self {
            Self {
    ...
    impl BrainAgentloopContract {
        ...
        where
            T: ::std::convert::TryInto<super::BrainAgentloopContractContract>,
            T::Error: ::std::fmt::Display,
        {
            self.contract = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<BrainAgentloopContract> for super::BrainAgentloopContract {
        type Error = super::error::ConversionError;
        fn try_from(
            value: BrainAgentloopContract,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
    ...
    impl ::std::convert::From<super::BrainAgentloopContract> for BrainAgentloopContract {
        fn from(value: super::BrainAgentloopContract) -> Self {
            Self {
    ...
    #[derive(Clone, Debug)]
    pub struct BrainAgentloopContractContract {
        activations: ::std::result::Result<::serde_json::Value, ::std::string::String>,
        ops: ::std::result::Result<::serde_json::Value, ::std::string::String>,
    }
    impl ::std::default::Default for BrainAgentloopContractContract {
        fn default() -> Self {
            Self {
                activations: Err("no value supplied for activations".to_string()),
                ops: Err("no value supplied for ops".to_string()),
            }
        }
    }
    impl BrainAgentloopContractContract {
        ...
        pub fn ops<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::serde_json::Value>,
            T::Error: ::std::fmt::Display,
        {
            self.ops = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for ops: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<BrainAgentloopContractContract>
        for super::BrainAgentloopContractContract
    {
        type Error = super::error::ConversionError;
        fn try_from(
            value: BrainAgentloopContractContract,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
    ...
    impl ::std::convert::From<super::BrainAgentloopContractContract>
        for BrainAgentloopContractContract
    {
        fn from(value: super::BrainAgentloopContractContract) -> Self {
            Self {
    ...
    pub struct CtxOpRequest {
        activation_id: ::std::result::Result<super::Identifier, ::std::string::String>,
        op: ::std::result::Result<super::CtxOp, ::std::string::String>,
        op_id: ::std::result::Result<super::Identifier, ::std::string::String>,
    }
    impl ::std::default::Default for CtxOpRequest {
        fn default() -> Self {
            Self {
                activation_id: Err("no value supplied for activation_id".to_string()),
                op: Err("no value supplied for op".to_string()),
                op_id: Err("no value supplied for op_id".to_string()),
            }
        }
    }
    impl CtxOpRequest {
        ...
        where
            T: ::std::convert::TryInto<super::CtxOp>,
            T::Error: ::std::fmt::Display,
        {
            self.op = value
                .try_into()
        ...
        pub fn op_id<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::Identifier>,
            T::Error: ::std::fmt::Display,
        {
            self.op_id = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for op_id: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<CtxOpRequest> for super::CtxOpRequest {
        type Error = super::error::ConversionError;
        fn try_from(
            value: CtxOpRequest,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::CtxOpRequest> for CtxOpRequest {
        fn from(value: super::CtxOpRequest) -> Self {
            Self {
                activation_id: Ok(value.activation_id),
                op: Ok(value.op),
                op_id: Ok(value.op_id),
            }
        }
    }
    #[derive(Clone, Debug)]
    pub struct MarkView {
        covers_through_seq: ::std::result::Result<super::Seq, ::std::string::String>,
        data: ::std::result::Result<super::JsonObject, ::std::string::String>,
        seq: ::std::result::Result<super::Seq, ::std::string::String>,
    }
    impl ::std::default::Default for MarkView {
        fn default() -> Self {
            Self {
                covers_through_seq: Err("no value supplied for covers_through_seq".to_string()),
    ...
    impl MarkView {
        pub fn covers_through_seq<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::Seq>,
            T::Error: ::std::fmt::Display,
        {
            self.covers_through_seq = value.try_into().map_err(|e| {
                format!("error converting supplied value for covers_through_seq: {e}")
            });
            self
        }
        pub fn data<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::JsonObject>,
            T::Error: ::std::fmt::Display,
        {
            self.data = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<MarkView> for super::MarkView {
        type Error = super::error::ConversionError;
        fn try_from(value: MarkView) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                covers_through_seq: value.covers_through_seq?,
                data: value.data?,
                seq: value.seq?,
            })
        }
    }
    impl ::std::convert::From<super::MarkView> for MarkView {
        fn from(value: super::MarkView) -> Self {
            Self {
                covers_through_seq: Ok(value.covers_through_seq),
                data: Ok(value.data),
                seq: Ok(value.seq),
            }
        }
    ...
    #[derive(Clone, Debug)]
    pub struct ModelRequest {
        max_tokens: ::std::result::Result<
            ::std::option::Option<::std::num::NonZeroU64>,
            ::std::string::String,
        >,
        messages:
            ::std::result::Result<::std::vec::Vec<super::ModelMessage>, ::std::string::String>,
        system: ::std::result::Result<
            ::std::option::Option<super::ModelRequestSystem>,
            ::std::string::String,
        >,
        temperature: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
        tools: ::std::result::Result<
            ::std::vec::Vec<super::ToolPresentationView>,
            ::std::string::String,
        >,
        top_p: ::std::result::Result<::std::option::Option<f64>, ::std::string::String>,
    }
    impl ::std::default::Default for ModelRequest {
        fn default() -> Self {
            Self {
                max_tokens: Ok(Default::default()),
    ...
    impl ModelRequest {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::ModelMessage>>,
            T::Error: ::std::fmt::Display,
        {
            self.messages = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::ModelRequestSystem>>,
            T::Error: ::std::fmt::Display,
        {
            self.system = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::ToolPresentationView>>,
            T::Error: ::std::fmt::Display,
        {
            self.tools = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<ModelRequest> for super::ModelRequest {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ModelRequest,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::ModelRequest> for ModelRequest {
        fn from(value: super::ModelRequest) -> Self {
            Self {
    ...
    #[derive(Clone, Debug)]
    pub struct SessionContextView {
        limits: ::std::result::Result<super::SessionContextViewLimits, ::std::string::String>,
        metadata:
            ::std::result::Result<::std::option::Option<super::JsonObject>, ::std::string::String>,
        model: ::std::result::Result<super::Identifier, ::std::string::String>,
        session_id: ::std::result::Result<super::SessionId, ::std::string::String>,
    }
    impl ::std::default::Default for SessionContextView {
        fn default() -> Self {
            Self {
    ...
    impl SessionContextView {
        ...
        where
            T: ::std::convert::TryInto<super::SessionContextViewLimits>,
            T::Error: ::std::fmt::Display,
        {
            self.limits = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::JsonObject>>,
            T::Error: ::std::fmt::Display,
        {
            self.metadata = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<SessionContextView> for super::SessionContextView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: SessionContextView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                limits: value.limits?,
    ...
    impl ::std::convert::From<super::SessionContextView> for SessionContextView {
        fn from(value: super::SessionContextView) -> Self {
            Self {
    ...
    #[derive(Clone, Debug)]
    pub struct SessionContextViewLimits {
        max_parallel_tools: ::std::result::Result<::std::num::NonZeroU64, ::std::string::String>,
        max_rounds_per_turn: ::std::result::Result<::std::num::NonZeroU64, ::std::string::String>,
        turn_wall_ms: ::std::result::Result<::std::num::NonZeroU64, ::std::string::String>,
    }
    impl ::std::default::Default for SessionContextViewLimits {
        fn default() -> Self {
            Self {
                max_parallel_tools: Err("no value supplied for max_parallel_tools".to_string()),
                max_rounds_per_turn: Err("no value supplied for max_rounds_per_turn".to_string()),
                turn_wall_ms: Err("no value supplied for turn_wall_ms".to_string()),
            }
        }
    }
    impl SessionContextViewLimits {
        pub fn max_parallel_tools<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::num::NonZeroU64>,
            T::Error: ::std::fmt::Display,
        {
            self.max_parallel_tools = value.try_into().map_err(|e| {
                format!("error converting supplied value for max_parallel_tools: {e}")
            });
            self
        }
        pub fn max_rounds_per_turn<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::num::NonZeroU64>,
            T::Error: ::std::fmt::Display,
        {
            self.max_rounds_per_turn = value.try_into().map_err(|e| {
                format!("error converting supplied value for max_rounds_per_turn: {e}")
            });
            self
        }
        pub fn turn_wall_ms<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::num::NonZeroU64>,
            T::Error: ::std::fmt::Display,
        {
            self.turn_wall_ms = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for turn_wall_ms: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<SessionContextViewLimits> for super::SessionContextViewLimits {
        type Error = super::error::ConversionError;
        fn try_from(
            value: SessionContextViewLimits,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                max_parallel_tools: value.max_parallel_tools?,
                max_rounds_per_turn: value.max_rounds_per_turn?,
                turn_wall_ms: value.turn_wall_ms?,
            })
        }
    }
    impl ::std::convert::From<super::SessionContextViewLimits> for SessionContextViewLimits {
        fn from(value: super::SessionContextViewLimits) -> Self {
            Self {
                max_parallel_tools: Ok(value.max_parallel_tools),
                max_rounds_per_turn: Ok(value.max_rounds_per_turn),
                turn_wall_ms: Ok(value.turn_wall_ms),
            }
        }
    }
    #[derive(Clone, Debug)]
    pub struct TextContentView {
        text: ::std::result::Result<super::TextContentViewText, ::std::string::String>,
        type_: ::std::result::Result<super::TextContentViewType, ::std::string::String>,
    }
    impl ::std::default::Default for TextContentView {
        fn default() -> Self {
            Self {
    ...
    impl TextContentView {
        ...
        where
            T: ::std::convert::TryInto<super::TextContentViewText>,
            T::Error: ::std::fmt::Display,
        {
            self.text = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<super::TextContentViewType>,
            T::Error: ::std::fmt::Display,
        {
            self.type_ = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<TextContentView> for super::TextContentView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: TextContentView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                text: value.text?,
                type_: value.type_?,
    ...
    impl ::std::convert::From<super::TextContentView> for TextContentView {
        fn from(value: super::TextContentView) -> Self {
            Self {
                text: Ok(value.text),
    ...
    #[derive(Clone, Debug)]
    pub struct ToolCallContentView {
        input: ::std::result::Result<super::JsonObject, ::std::string::String>,
        name: ::std::result::Result<super::Identifier, ::std::string::String>,
        tool_call_id: ::std::result::Result<super::Identifier, ::std::string::String>,
        type_: ::std::result::Result<super::ToolCallContentViewType, ::std::string::String>,
    }
    impl ::std::default::Default for ToolCallContentView {
        fn default() -> Self {
            Self {
    ...
    impl ToolCallContentView {
        ...
        pub fn type_<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::ToolCallContentViewType>,
            T::Error: ::std::fmt::Display,
        {
            self.type_ = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<ToolCallContentView> for super::ToolCallContentView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ToolCallContentView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                input: value.input?,
                name: value.name?,
    ...
    impl ::std::convert::From<super::ToolCallContentView> for ToolCallContentView {
        fn from(value: super::ToolCallContentView) -> Self {
            Self {
    ...
    impl ::std::default::Default for ToolCallRequest {
        fn default() -> Self {
            Self {
                input: Err("no value supplied for input".to_string()),
                name: Err("no value supplied for name".to_string()),
    ...
    impl ::std::convert::TryFrom<ToolCallRequest> for super::ToolCallRequest {
        type Error = super::error::ConversionError;
        fn try_from(
    ...
    impl ::std::convert::From<super::ToolCallRequest> for ToolCallRequest {
        fn from(value: super::ToolCallRequest) -> Self {
            Self {
                input: Ok(value.input),
                name: Ok(value.name),
                tool_call_id: Ok(value.tool_call_id),
    ...
    pub struct ToolPresentationView {
        description: ::std::result::Result<
            ::std::option::Option<super::ToolPresentationViewDescription>,
            ::std::string::String,
        >,
        input_schema: ::std::result::Result<super::JsonObject, ::std::string::String>,
        name: ::std::result::Result<super::Identifier, ::std::string::String>,
    }
    impl ::std::default::Default for ToolPresentationView {
        fn default() -> Self {
            Self {
    ...
    impl ::std::convert::TryFrom<ToolPresentationView> for super::ToolPresentationView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ToolPresentationView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
    ...
    impl ::std::convert::From<super::ToolPresentationView> for ToolPresentationView {
        fn from(value: super::ToolPresentationView) -> Self {
            Self {
    ...
    pub struct ToolResultView {
        content:
            ::std::result::Result<::std::vec::Vec<super::TextContentView>, ::std::string::String>,
        is_error: ::std::result::Result<bool, ::std::string::String>,
        name: ::std::result::Result<super::Identifier, ::std::string::String>,
        tool_call_id: ::std::result::Result<super::Identifier, ::std::string::String>,
    }
    impl ::std::default::Default for ToolResultView {
        fn default() -> Self {
            Self {
                content: Err("no value supplied for content".to_string()),
    ...
    impl ToolResultView {
        pub fn content<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::TextContentView>>,
            T::Error: ::std::fmt::Display,
        {
            self.content = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<ToolResultView> for super::ToolResultView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ToolResultView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                content: value.content?,
    ...
    impl ::std::convert::From<super::ToolResultView> for ToolResultView {
        fn from(value: super::ToolResultView) -> Self {
            Self {
                content: Ok(value.content),
    ...
    #[derive(Clone, Debug)]
    pub struct UsageView {
        cache_read_tokens: ::std::result::Result<::std::option::Option<u64>, ::std::string::String>,
        cache_write_tokens:
        ...
        total_tokens: ::std::result::Result<::std::option::Option<u64>, ::std::string::String>,
    }
    impl ::std::default::Default for UsageView {
        fn default() -> Self {
            Self {
                cache_read_tokens: Ok(Default::default()),
                cache_write_tokens: Ok(Default::default()),
                input_tokens: Ok(Default::default()),
                output_tokens: Ok(Default::default()),
                total_tokens: Ok(Default::default()),
            }
        }
    }
    impl UsageView {
        pub fn cache_read_tokens<T>(mut self, value: T) -> Self
        where
            ...
            T::Error: ::std::fmt::Display,
        {
            self.cache_read_tokens = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for cache_read_tokens: {e}"));
            self
        }
        pub fn cache_write_tokens<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<u64>>,
            T::Error: ::std::fmt::Display,
        {
            self.cache_write_tokens = value.try_into().map_err(|e| {
                format!("error converting supplied value for cache_write_tokens: {e}")
            });
            self
        }
        ...
        pub fn total_tokens<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<u64>>,
            T::Error: ::std::fmt::Display,
        {
            self.total_tokens = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for total_tokens: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<UsageView> for super::UsageView {
        type Error = super::error::ConversionError;
        fn try_from(
            value: UsageView,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::UsageView> for UsageView {
        fn from(value: super::UsageView) -> Self {
            Self {
                cache_read_tokens: Ok(value.cache_read_tokens),
                cache_write_tokens: Ok(value.cache_write_tokens),
                input_tokens: Ok(value.input_tokens),
                output_tokens: Ok(value.output_tokens),
                total_tokens: Ok(value.total_tokens),
            }
        }
    }
}
