...
- [ADR-048: Separate Tool return from finish and activate the loop from committed events](2026-09-21-01-tool-completion-and-event-activation.md) — implemented in 0.28.
